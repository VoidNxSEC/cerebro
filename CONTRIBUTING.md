...
├── core/                   # Core business logic (RAG, Extraction)
├── intelligence/           # AI/LLM specialized logic
├── interfaces/             # Abstract base classes
├── modules/                # Specialized functional modules
├── nats/                   # NATS messaging integration
├── providers/              # Concrete implementations (LLM, Vector Store)
├── registry/               # Provider & module registry
